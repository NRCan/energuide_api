...
const resolvers = {
  ...
  Evaluation: {
    ...
    fursseff: root => root.FURSSEFF,
    furnaceFuel: root => root.FURNACEFUEL,
    hpsource: root => root.HPSOURCE,
    cop: root => root.COP,
    pdhwtype: root => root.PDHWTYPE,
    pdhwef: root => root.PDHWEF,
    pdhwfuel: root => root.PDHWFUEL,
    dhwhptype: root => root.DHWHPTYPE,
    dhwhpcop: root => root.DHWHPCOP,
    csia: root => root.CSIA,
    typeOfHouse: root => root.TYPEOFHOUSE,
    ceilins: root => root.CEILINS,
    fndwallins: root => root.FNDWALLINS,
